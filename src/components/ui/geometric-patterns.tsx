  ...
  return (
    ...
    >
      ...
      <g className="animated-pattern" style={{ transformOrigin: '800px 300px' }}>
        <polygon
          points="800,200 750,300 850,300"
          fill="none"
      ...
      <g className="animated-pattern" style={{ transformOrigin: '300px 700px' }}>
        <polygon
          points="300,650 350,675 350,725 300,750 250,725 250,675"
          fill="none"
          stroke="url(#gradient1)"
          strokeWidth="2"
          opacity="0.5"
        />
        <polygon
          points="300,670 330,685 330,715 300,730 270,715 270,685"
          fill="url(#gradient1)"
          opacity="0.1"
        />
      </g>
      ...
      <g className="animated-pattern" style={{ transformOrigin: '700px 800px' }}>
        <polygon
          points="700,750 750,775 750,825 700,850 650,825 650,775"
          fill="none"
          stroke="url(#gradient2)"
          strokeWidth="2"
          opacity="0.5"
        />
        <polygon
          points="700,770 730,785 730,815 700,830 670,815 670,785"
          fill="url(#gradient2)"
          opacity="0.1"
        />
      </g>
